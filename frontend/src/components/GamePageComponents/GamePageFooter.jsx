...
function GamePageFooter({ roomId, systemMessage, stompClient, gameData, nowGameState, session, chatHistory, chatMode, players }) {
    // 모달을 열고 닫을 변수
            ...
            <div className={styles.container}>
                <div className={styles.footer}>
                    ...
                    <GameChat   systemMessage={systemMessage}
                                ...
                                players={players}
                                />
                    <GameReadyStartBtn roomId={roomId} stompClient={stompClient} nowGameState={nowGameState} gameData={gameData}/>
                </div>
