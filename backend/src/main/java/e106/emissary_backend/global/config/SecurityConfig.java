...
//                }));
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/api/login","/", "/api/user", "/api/mail", "/api/reissue", "/api/logout", "/api/oauth2/token", "/api/oauth2/login", "/api/checkemail", "/api/checknick", "/api/users/verify", "/api/users/verifypw", "/api/updatelostpw").permitAll()
